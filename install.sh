...
if is_debian_like; then
  ...
  apt_install software-properties-common ca-certificates curl git wget gnupg lsb-release fontconfig build-essential pkg-config unzip fd-find pipx lazygit
